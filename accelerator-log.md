...
```json
{
  "projectName" : "customer-profile-ui",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->customer-profile-ui]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: customer-profile-u...(truncated)]
